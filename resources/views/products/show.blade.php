...
<body>
    ...
    <div class="comments-container">
        ...
        <div class="review-card">
            ...
            <div class="review-meta">
                ...
                <span>Helpful: {{ $review->votes->sum(fn($v) => $v->is_upvote ? 1 : -1) }}</span>
            </div>
    ...
    @if(auth()->check())
    <form class="bookmark-form" method="POST" action="{{ route('bookmarks.toggle', $product->id) }}">
        @csrf
        <button type="submit" class="bookmark-btn">
            <i class="fas fa-bookmark"></i> {{ auth()->user()->bookmarks->contains('product_id', $product->id) ? 'Saved' : 'Save for Later' }}
        </button>
    </form>
    @endif
